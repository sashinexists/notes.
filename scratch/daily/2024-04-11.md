...
- (6:22午後) you should make a document type with a file name and title too
  - or just a title, which becomes the file name
  - no, just a filename, and it doesn't include the extension
